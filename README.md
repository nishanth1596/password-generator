...
- Solution URL: [Solution URL](https://github.com/nishanth1596/password-generator)
- Live Site URL: [Live site URL](https://nishanth-password-generator.netlify.app)
...
1. Clone this repository:
   ...
   ```bash
   git clone https://github.com/nishanth1596/password-generator.git
   ```
...
Google Fonts - I used the JetBrains Mono fonts from Google Fonts to style the text.
